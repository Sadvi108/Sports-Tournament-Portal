    ...
    <div className="min-h-screen transition-colors duration-300 dark:bg-deep-black bg-gray-50">
      ...
      <main className="pt-32 pb-20 px-6 max-w-6xl mx-auto space-y-10">
        ...
        <div className="flex items-center gap-4 mb-12">
          ...
          <div>
            <h1 className="text-4xl font-black tracking-tighter dark:text-white text-dark-gray uppercase leading-none">
        ...
        <form onSubmit={handleSubmit} className="space-y-10">
          ...
          <div className="dark-card p-10 bg-white dark:bg-white/5 shadow-2xl dark:shadow-none space-y-8">
            <div className="flex items-center gap-3 border-b border-gray-100 dark:border-white/5 pb-6 mb-2">
              ...
              <h2 className="text-2xl font-black dark:text-white text-dark-gray uppercase tracking-tighter">Club Details</h2>
            </div>
            
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-8">
              {/* Row 1 */}
              <div className="space-y-3">
                <label className="text-xs font-black uppercase tracking-widest text-muted-gray px-1">Club Code <span className="text-rose-pink">*</span></label>
              ...
              <div className="space-y-3">
                <label className="text-xs font-black uppercase tracking-widest text-muted-gray px-1">Club Name <span className="text-rose-pink">*</span></label>
                <input required className="w-full bg-gray-50 dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-2xl py-4 px-6 focus:outline-none focus:border-rose-pink/50 transition-all" />
              </div>

              {/* Row 2 */}
              <div className="space-y-3">
                <label className="text-xs font-black uppercase tracking-widest text-muted-gray px-1">Head Instructor Name</label>
              ...
              <div className="space-y-3">
                <label className="text-xs font-black uppercase tracking-widest text-muted-gray px-1">Club Type <span className="opacity-50 font-normal">(Pre-selected from sport type)</span></label>
              ...
              {/* Row 3 */}
              <div className="space-y-3">
                <label className="text-xs font-black uppercase tracking-widest text-muted-gray px-1">Address Line1</label>
              ...
              <div className="space-y-3">
                <label className="text-xs font-black uppercase tracking-widest text-muted-gray px-1">Address Line2</label>
                <textarea rows={3} className="w-full bg-gray-50 dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-2xl py-4 px-6 focus:outline-none focus:border-rose-pink/50 transition-all resize-none" />
              </div>

              {/* Row 4 */}
              <div className="space-y-3">
                <label className="text-xs font-black uppercase tracking-widest text-muted-gray px-1">State</label>
                <input className="w-full bg-gray-50 dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-2xl py-4 px-6 focus:outline-none focus:border-rose-pink/50 transition-all" />
              </div>
              <div className="space-y-3">
                <label className="text-xs font-black uppercase tracking-widest text-muted-gray px-1">Country</label>
                <div className="relative">
              ...
              {/* Row 5 */}
              <div className="space-y-3">
                <label className="text-xs font-black uppercase tracking-widest text-muted-gray px-1">Phone Code</label>
                <div className="relative">
                  <select className="w-full bg-gray-50 dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-2xl py-4 px-6 focus:outline-none focus:border-rose-pink/50 transition-all appearance-none cursor-pointer">
              ...
              <div className="space-y-3">
                <label className="text-xs font-black uppercase tracking-widest text-muted-gray px-1">WhatsappNo</label>
          ...
          <div className="dark-card p-10 bg-white dark:bg-white/5 shadow-2xl dark:shadow-none space-y-8">
            <div className="flex items-center gap-3 border-b border-gray-100 dark:border-white/5 pb-6 mb-2">
              <div className="w-2 h-8 bg-rose-pink rounded-full" />
              <h2 className="text-2xl font-black dark:text-white text-dark-gray uppercase tracking-tighter">Login Credentials</h2>
            </div>
            
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-8">
              <div className="space-y-3">
                <label className="text-xs font-black uppercase tracking-widest text-muted-gray px-1">Login Email <span className="text-rose-pink">*</span></label>
              ...
              <div className="space-y-3">
                <label className="text-xs font-black uppercase tracking-widest text-muted-gray px-1">Password <span className="text-rose-pink">*</span></label>
              ...
              <div className="space-y-3">
                <label className="text-xs font-black uppercase tracking-widest text-muted-gray px-1">Confirm Password <span className="text-rose-pink">*</span></label>
                <input type="password" required className="w-full bg-gray-50 dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-2xl py-4 px-6 focus:outline-none focus:border-rose-pink/50 transition-all" />
              </div>
            </div>
        ...
        <div className="dark-card p-10 bg-white dark:bg-white/5 shadow-xl dark:shadow-none border-l-8 border-rose-pink space-y-8">
          <div className="flex items-center gap-4">
            ...
            <h2 className="text-xl font-black dark:text-white text-dark-gray uppercase tracking-tighter">Notice for D-Clix Users / Notis untuk Pengguna D-Clix</h2>
          </div>
          <div className="space-y-8 text-sm leading-relaxed">
            <div className="space-y-4">
              <p className="font-black dark:text-white text-dark-gray text-base">All existing and past D-Clix users can use their current club code, ID, and password to log in and register players for this tournament.</p>
          ...
          {isSubmitted && (
            ...
            >
              ...
              >
                ...
                <h2 className="text-4xl font-black uppercase tracking-tighter mb-4 dark:text-white text-dark-gray">Success!</h2>
