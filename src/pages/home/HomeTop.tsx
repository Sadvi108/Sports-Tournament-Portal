...
const SportImage = ({ baseName, alt, glow }: { baseName: string; alt: string; glow: string }) => {
  ...
  return (
    <img
      alt={alt}
      src={src}
      onError={() => setIdx((v) => (v < exts.length - 1 ? v + 1 : v))}
      className={`w-full h-full object-contain opacity-60 group-hover:opacity-100 transition-opacity translate-y-6 scale-[1.18] invert mix-blend-screen ${glow}`}
    />
  );
};
...
const JudoImage = () => (
  <div className="relative overflow-hidden aspect-square flex items-center justify-center group">
    ...
    <div className="w-4/5 h-4/5 bg-[#121212] border-2 border-emerald-500/20 flex items-center justify-center relative" style={{ clipPath: 'polygon(25% 0%, 75% 0%, 100% 50%, 75% 100%, 25% 100%, 0% 50%)' }}>
      <SportImage baseName="judo" alt="Judo Silhouette" glow="drop-shadow-[0_0_12px_rgba(16,185,129,0.8)]" />
      <div className="absolute top-0 left-0 right-0 h-12 bg-gradient-to-b from-[#121212] to-transparent pointer-events-none" />
    </div>
  </div>
);
...
const SoccerImage = () => (
  <div className="relative overflow-hidden aspect-square flex items-center justify-center group">
    ...
    <div className="w-4/5 h-4/5 bg-[#121212] border-2 border-orange-500/20 flex items-center justify-center relative" style={{ clipPath: 'polygon(25% 0%, 75% 0%, 100% 50%, 75% 100%, 25% 100%, 0% 50%)' }}>
      <SportImage baseName="soccer" alt="Soccer Silhouette" glow="drop-shadow-[0_0_12px_rgba(249,115,22,0.8)]" />
      <div className="absolute top-0 left-0 right-0 h-12 bg-gradient-to-b from-[#121212] to-transparent pointer-events-none" />
    </div>
  </div>
);
...
const SumoImage = () => (
  <div className="relative overflow-hidden aspect-square flex items-center justify-center group">
    ...
    <div className="w-4/5 h-4/5 bg-[#121212] border-2 border-violet-500/20 flex items-center justify-center relative" style={{ clipPath: 'polygon(25% 0%, 75% 0%, 100% 50%, 75% 100%, 25% 100%, 0% 50%)' }}>
      <SportImage baseName="sumo" alt="Sumo Silhouette" glow="drop-shadow-[0_0_12px_rgba(139,92,246,0.8)]" />
      <div className="absolute top-0 left-0 right-0 h-12 bg-gradient-to-b from-[#121212] to-transparent pointer-events-none" />
    </div>
  </div>
);
...
const HexCanvasCard = ({ 
  ...
  return (
    <motion.div 
      ...
      className={`flex flex-col items-center gap-2 sm:gap-4 ${type}`}
    ...
    >
      ...
      >
        <div className="relative w-[210px] h-[190px] sm:w-[230px] sm:h-[205px] lg:w-[260px] lg:h-[228px]">
          <div 
          ...
          />
          <div 
            className="absolute inset-[4px] sm:inset-[5px] overflow-hidden bg-[#050811]"
          ...
          >
            ...
            <div className="absolute inset-0 pointer-events-none z-10">
              ...
              <div className="absolute w-[10px] h-[10px] sm:w-[12px] sm:h-[12px] opacity-70 top-[18%] left-[24%] border-t-[1.5px] border-l-[1.5px] border-[var(--sc)]" />
              <div className="absolute w-[10px] h-[10px] sm:w-[12px] sm:h-[12px] opacity-70 top-[18%] right-[24%] border-t-[1.5px] border-r-[1.5px] border-[var(--sc)]" />
              <div className="absolute w-[10px] h-[10px] sm:w-[12px] sm:h-[12px] opacity-70 bottom-[18%] left-[24%] border-b-[1.5px] border-l-[1.5px] border-[var(--sc)]" />
              <div className="absolute w-[10px] h-[10px] sm:w-[12px] sm:h-[12px] opacity-70 bottom-[18%] right-[24%] border-b-[1.5px] border-r-[1.5px] border-[var(--sc)]" />
              <div className="absolute bottom-[20%] left-1/2 -translate-x-1/2 text-[5px] sm:text-[6px] tracking-[0.9px] font-mono text-[var(--sc)] opacity-40 whitespace-nowrap">
                {hudCode}
              </div>
            </div>
          </div>
      ...
      <div className="text-center">
        <span className="font-bold text-[14px] sm:text-[16px] uppercase tracking-[1.2px] block font-[Barlow_Condensed,sans-serif]" style={{ color: 'var(--sc)' }}>
          {title}
        </span>
      </div>
    </motion.div>
        ...
        <div className="max-w-[1400px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-10">
          ...
          <div className="relative w-full py-10 lg:py-0">
            ...
            <Reveal delay={0.4} className="w-full h-full relative flex items-center justify-center">
              <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4 md:gap-5 xl:gap-6 place-items-center w-full max-w-[1200px] relative z-10">
                <HexCanvasCard 
                  type="karate" 
                  title="Karate" 
